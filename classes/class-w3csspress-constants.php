	...
	class W3csspress_Constants {
		...
		public static function w3csspress_additional_selectors() {
			...
			array_push(
				...
				array(
					'selector' => './/input[not(@type="button" or @type="submit" or @type="reset" or @type="checkbox" or @type="radio" or contains(@class,"sidebar") or(ancestor::*/@id="wpadminbar"))]',
					'classes'  => 'w3-input',
				),
				array(
					'selector' => '(.//button|.//reset)[not(ancestor::*/@id="wpadminbar")]',
					'classes'  => 'w3-btn w3-theme-action',
				),
				array(
					'selector' => './/input[@type="button" or @type="submit" or @type="reset" and not (ancestor::*/@id="wpadminbar")]',
					'classes'  => 'w3-btn',
				),
				array(
					'selector' => '(.//input|.//textarea)[not(ancestor::*/@id="wpadminbar")]',
					'classes'  => 'w3-theme-action',
				),
				array(
					'selector' => './/input[@type="checkbox" and not (ancestor::*/@id="wpadminbar")]',
					'classes'  => 'w3-check',
				),
				array(
				...
				array(
					'selector' => './/ul[not (ancestor::*/@id="wpadminbar")]',
					'classes'  => 'w3-ul',
				),
				array(
				...
				array(
					'selector' => '(//article|//section|//nav|//summary|//button|//reset|//input[not (@type="checkbox" or @type="radio")]|//textarea|//ul|//ol)[not (ancestor::*/@id="wpadminbar")]',
